...
def visualize_hog(original, hog_image):
    fig = plt.figure()
    plt.subplot(1, 4, 1)
...
def main():
    ...
    parser.add_argument('-c', '--colorspace', default='YUV', help='Colorspace to use for features. Can be RGB, LUV, HLS, YUV, or YCrCb.')
